		...
		<footer className="bg-custom-dark-gray text-gray-400 py-8">
			<div className="container mx-auto flex flex-col items-center">
				<div className="flex space-x-6 mb-4 text-gray-400">
					...
					<a href="https://github.com/lraveri" aria-label="GitHub" className="text-gray-400">
						<FontAwesomeIcon icon={faGithub} className="text-2xl" />
					</a>
					<a href="https://www.linkedin.com/in/lucaraveri" aria-label="LinkedIn" className="text-gray-400">
